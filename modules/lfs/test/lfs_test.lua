--[[------------------------------------------------------
  ...
  These tests have been adaptes from the original tests
...
function should.return_version_string()
  assert_match('1.4.2', lfs._VERSION)
end

function should.get_file_attributes()
  local attrs = lfs.attributes('some/path')
