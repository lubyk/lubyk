...
static int QWidget_adjustSize(lua_State *L) {
  try {
    TableView *self = *((TableView**)dubL_checksdata(L, 1, "mimas.TableView"));
    if (!self) throw dub::Exception("Using deleted mimas.TableView in adjustSize");
    self->adjustSize();
    return 0;
  } catch (std::exception &e) {
...
static int QWidget_position(lua_State *L) {
  try {
    TableView *self = *((TableView**)dubL_checksdata(L, 1, "mimas.TableView"));
    if (!self) throw dub::Exception("Using deleted mimas.TableView in position");
...
static int QWidget_setAttribute(lua_State *L) {
  try {
    TableView *self = *((TableView**)dubL_checksdata(L, 1, "mimas.TableView"));
    if (!self) throw dub::Exception("Using deleted mimas.TableView in setAttribute");
...
static int QWidget_setFocus(lua_State *L) {
  try {
    TableView *self = *((TableView**)dubL_checksdata(L, 1, "mimas.TableView"));
    if (!self) throw dub::Exception("Using deleted mimas.TableView in setFocus");
...
static int QWidget_setFocusPolicy(lua_State *L) {
  try {
    TableView *self = *((TableView**)dubL_checksdata(L, 1, "mimas.TableView"));
    if (!self) throw dub::Exception("Using deleted mimas.TableView in setFocusPolicy");
