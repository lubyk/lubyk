...
**
** Created: Sat Feb 18 09:04:41 2012
...
void mimas::Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData mimas::Application::staticMetaObjectExtraData = {
...
const QMetaObject mimas::Application::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_mimas__Application,
      qt_meta_data_mimas__Application, &staticMetaObjectExtraData }
};
...
void *mimas::Application::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ThreadedLuaObject"))
        return static_cast< ThreadedLuaObject*>(const_cast< Application*>(this));
