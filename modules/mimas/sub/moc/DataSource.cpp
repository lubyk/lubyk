...
void mimas::DataSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData mimas::DataSource::staticMetaObjectExtraData = {
...
const QMetaObject mimas::DataSource::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_mimas__DataSource,
      qt_meta_data_mimas__DataSource, &staticMetaObjectExtraData }
};
