...
void mimas::GroupBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData mimas::GroupBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mimas::GroupBox::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_mimas__GroupBox,
      qt_meta_data_mimas__GroupBox, &staticMetaObjectExtraData }
};
