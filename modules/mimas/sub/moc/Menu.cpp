...
void mimas::Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData mimas::Menu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mimas::Menu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_mimas__Menu,
      qt_meta_data_mimas__Menu, &staticMetaObjectExtraData }
};
