...
static const char qt_meta_stringdata_mimas__Slider[] = {
    "mimas::Slider\0\0sliderChanged(double)\0"
    "remote_value\0setValue(double)\0value\0"
    "sliderChangedSlot(double)\0QString\0"
    "class\0float\0hue\0int\0border\0"
};

void mimas::Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Slider *_t = static_cast<Slider *>(_o);
        switch (_id) {
        case 0: _t->sliderChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->setValue((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->sliderChangedSlot((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData mimas::Slider::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mimas::Slider::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mimas__Slider,
      qt_meta_data_mimas__Slider, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void mimas::Slider::sliderChanged(double _t1)
{
