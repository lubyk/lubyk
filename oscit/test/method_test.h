...
public:
  void test_trigger_class_method( void ) {
    Root root;
    root.adopt(new ClassMethod("hello", &Person::class_method, TextIO("", "Send me strings only.")));
    Value res;
  ...
  void test_trigger_method( void ) {
    ...
    eva->adopt(new Method(eva, "name", &Method::cast_method<Person, &Person::name>, TextIO("", "Name of the person.")));
    Value res;
  ...
  void test_trigger_method_tmethod_syntax( void ) {
    ...
    eva->adopt(new TMethod<Person, &Person::name>(eva, "name", TextIO("", "Name of the person.")));
    Value res;
