...
class DictionaryTest : public ValueTestHelper
{
public:
  ...
  {
    Dictionary dict("first:1 second:2 name:\"foo\"");
...
//  {
//    DictionaryData dict("first:1 second:2 name:\"yoba\"");
...
//  }
  ...
  void test_stream( void )
  {
    ...
    out.str(std::string(""));
    out << v;
    TS_ASSERT_EQUALS(out.str(), "<Dictionary[1] first:1 second:2 name:\"Gaspard Buma\" joy:3.5>");
  }
