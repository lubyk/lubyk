...
public:
  ...
  {
    create("/v1",  "Number", "value:2",  "[6] /v1");
    create("/v2",  "Number", "value:3",  "[12] /v2");
    create("/add", "Add",   "",          "[16] /add"); 
    create("/v3",  "Number", "value:0",  "[25] /v3");
    ...
    assert_inspect("/v1", "<Number:/v1 [2] 2.00>");
    assert_inspect("/v2", "<Number:/v2 [8] 3.00>");
    assert_inspect("/add","<Add:/add [20] 0.00>");
    assert_inspect("/v3", "<Number:/v3 [21] 0.00>");
    ...
    assert_inspect("/v1", "<Number:/v1 [2] 2.00>");
    assert_inspect("/v2", "<Number:/v2 [8] 3.00>");
    assert_inspect("/add","<Add:/add [20] 3.00>");
    assert_inspect("/v3", "<Number:/v3 [21] 0.00>");
    ...
    assert_inspect("/v2", "<Number:/v2 [8] 3.00>");
    assert_inspect("/add","<Add:/add [20] 3.00>");
    assert_inspect("/v3", "<Number:/v3 [21] 3.00>");
    ...
    assert_inspect("/v1", "<Number:/v1 [2] 2.00>");
    assert_inspect("/v2", "<Number:/v2 [8] 3.00>");
    assert_inspect("/add","<Add:/add [20] 5.00>");
    assert_inspect("/v3", "<Number:/v3 [21] 5.00>");
  }
//  
